...
<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
>>>>>>> a6ade19d010028a412f2d85042c7e3fba2027bad
         pageEncoding="ISO-8859-1"%>
<!DOCTYPE html>
<html>
<head>
    <meta http-equiv="Content-Type" content="text/html; charset=ISO-8859-1">
    <link rel="stylesheet" href="css/notFoundPageStyle.css">
...
<div class="container">
    ...
    <div class="text">
        <div class="text-inner">
            ...
            <h2> <c:out value="${ exception.message }"></c:out></h2>

            <div id="home" class="button">
                <h3><a onclick="location.href='/'"><i>Back to Login</i></a></h3>
            </div>
        </div>
